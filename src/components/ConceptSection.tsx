...
const steps = [
  ...
  },
  {
    ...
    title: "Verbinden",
    description:
      "Lernen Sie Pflegekräfte persönlich kennen. Chatten, telefonieren oder treffen Sie sich – ganz nach Ihrem Wunsch.",
    icon: MessageCircle,
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted text-lg max-w-2xl mx-auto">
            Von der Suche bis zur ersten Begegnung – wir machen den Weg zur
            perfekten Betreuung so einfach wie möglich.
          </p>
        </motion.div>
