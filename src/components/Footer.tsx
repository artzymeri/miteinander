  ...
  return (
    <footer id="footer" className="bg-primary text-white py-16 md:py-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-12 md:gap-8 mb-12">
          ...
          >
            ...
            <p className="text-white/70 text-sm leading-relaxed max-w-xs">
              Verbinden Sie sich direkt mit Pflegekräften. Für menschliche
          ...
          >
            <h4 className="font-serif text-lg mb-4">Folgen Sie uns</h4>
        ...
        >
          <p>© {new Date().getFullYear()} Miteinander. Alle Rechte vorbehalten.</p>
